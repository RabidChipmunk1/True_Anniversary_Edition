...
bool	KNEnable		<string UIName = "Use Nighteye Fix";>																		= {false};
		float	KNDetect1		<string UIName="Params01[5].w > VALUE*0.1";string UIWidget="Spinner";float UIMin=0.0;float UIMax=2.0;>		= {0.97};
		float	KNDetect2		<string UIName="Params01[5].w < VALUE*0.1";string UIWidget="Spinner";float UIMin=0.0;float UIMax=2.0;>		= {0.99};
...
technique11 Draw <string UIName="OW RUDY DEFAULT";>
{
   pass p0
   {
...
technique11 Preset1 <string UIName="OW VARIANT 1";>
{
   pass p0
   {
      SetVertexShader(CompileShader(vs_5_0, VS_Draw()));
...
technique11 Preset2 <string UIName="OW VARIANT 2";>
{
   pass p0
   {
      SetVertexShader(CompileShader(vs_5_0, VS_Draw()));
...
technique11 Preset3 <string UIName="OW JJENSSON";>
{
   pass p0
   {
      SetVertexShader(CompileShader(vs_5_0, VS_Draw()));
...
Texture2D          LUT_Preset4 < string UIName = "3DLut1";  string ResourceName = "LUT_Preset4.png"; >; // Preset4 Lut
technique11 Preset4 <string UIName="B&W";>
{
   pass p0
   {
      SetVertexShader(CompileShader(vs_5_0, VS_Draw()));
      SetPixelShader(CompileShader(ps_5_0, PS_Draw(LUT_Preset4, true)));
   }
}

Texture2D          LUT_Preset5 < string UIName = "3DLut1";  string ResourceName = "LUT_Preset5.png"; >; // Preset5 Lut
technique11 Preset5 <string UIName="UNTOCHED";>
{
   pass p0
   {
      SetVertexShader(CompileShader(vs_5_0, VS_Draw()));
      SetPixelShader(CompileShader(ps_5_0, PS_Draw(LUT_Preset5, true)));
   }
}

Texture2D          LUT_Preset6 < string UIName = "3DLut1";  string ResourceName = "LUT_Preset6.png"; >; // Preset6 Lut
technique11 Preset6 <string UIName="MY WORK";>
{
   pass p0
   {
      SetVertexShader(CompileShader(vs_5_0, VS_Draw()));
      SetPixelShader(CompileShader(ps_5_0, PS_Draw(LUT_Preset6, true)));
   }
}
