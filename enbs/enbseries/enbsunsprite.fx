...
//
//////////////////////////////////////////////////////////////////////////////////
        int    Lens_Settings        <string UIName="\n+++++ Lens +++++";    float UIMin=0; float UIMax=0;   > ={ 0};
...
S_GLARE int    Glare_Settings       <string UIName="\n+++++ Glare +++++";   float UIMin=0; float UIMax=0;   > ={ 0};
...
#ifdef ENABLE_CORONA
        int    Corona_Settings      <string UIName="\n+++++ Corona +++++"; float UIMin=0; float UIMax=0;   > ={ 0};
...
#endif
        int    Global_Settings      <string UIName="\n+++++ Sprite +++++";  float UIMin=0; float UIMax=0;   > ={ 0};
...
S_CONST float  Sprite_Diff_Mod      = 200;                                                                               // Sprite diffraction pattern frequency(strips around edges)
        ...
        int    G1_Settings          <string UIName="\n+++++ Group1 +++++";  float UIMin=0; float UIMax=0;   > ={ 0}; // 9 small
...
ADV_UI  float  G1_Feather           <string UIName="G1_Feather";            float UIMin=1;                  > ={ 0.85};
        ...
        int    G2_Settings          <string UIName="\n+++++ Group2 +++++";  float UIMin=0; float UIMax=0;   > ={ 0}; // 9 small
...
ADV_UI  float  G2_Feather           <string UIName="G2_Feather";            float UIMin=1;                  > ={ 0.85};
        ...
        int    G3_Settings          <string UIName="\n+++++ Group3 +++++";  float UIMin=0; float UIMax=0;   > ={ 0}; // 9 large
...
ADV_UI  float  G3_Feather           <string UIName="G3_Feather";            float UIMin=1;                  > ={ 0.85};
        ...
        int    G4_Settings          <string UIName="\n+++++ Group4 +++++";  float UIMin=0; float UIMax=0;   > ={ 0}; // 9 large
